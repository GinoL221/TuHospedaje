...
export default function ShareModal({ lodging, onClose }) {
	...
	const [message, setMessage] = useState(
		`Mirá este alojamiento en TuHospedaje: ${lodging.name}`,
	);
	...
	const handleInstagram = async () => {
		try {
			...
			setCopyStatus("El contenido fue copiado. Completá la publicación en Instagram.");
		} catch {
			setCopyStatus("No se pudo copiar el contenido para Instagram");
		}
	};
  ...
  return (
			...
			>
					...
					<label className="share-message-label" htmlFor={`${titleId}-message`}>
