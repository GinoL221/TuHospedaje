...
<h3 style="page-break-before: always;">2.2. Frontend (React + Vite)</h3>
...
<img src="./sprint-2-data-model.svg" alt="Diagrama del modelo de datos del Sprint 2" style="width: 68%; display: block; margin: 8px auto 24px auto;" />
